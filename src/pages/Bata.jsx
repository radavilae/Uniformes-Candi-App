...
import img1 from "../assets/bata/MOD-0090.jpg";
...
const Bata = () => {
  ...
  const getImageInfo = (idx) => {
    const product = getProductData('bata', idx);
    return `MOD. ${product.code}`;
  };

  const getProductDetails = (idx) => {
    return getProductData('bata', idx);
  };
